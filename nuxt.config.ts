...
export default defineNuxtConfig({
  ...
  css: ['~/assets/css/fonts.css', '~/assets/css/main.css', '~/assets/css/drawer.css', '~/assets/css/auth.css', '~/assets/css/companion.css', '~/assets/css/companion-card.css', '~/assets/css/companion-cover.css', '~/assets/css/companion-public.css', '~/assets/css/companion-club.css', '~/assets/css/companion-carousel.css', '~/assets/css/companion-public-carousel.css', '~/assets/css/companion-video-list.css', '~/assets/css/companion-public-video-list.css', '~/assets/css/profile.css', '~/assets/css/shop.css'],
  runtimeConfig: {
