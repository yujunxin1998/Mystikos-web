...
Object.assign(copy.zh, {
  ...
  'directory.eyebrow': '陪玩清单 · 公开名片', 'directory.title': '今晚想和谁并肩', 'directory.open': '向所有 Mystikos 会员开放', 'directory.intro': '查看陪玩的擅长游戏、陪伴风格与当前状态。选择一张名片，进入完整公开主页。', 'directory.search': '搜索名称、游戏或陪伴风格', 'directory.filterLabel': '陪玩筛选', 'directory.all': '全部', 'directory.heading': '公会陪玩', 'directory.count': '共 {count} 位陪玩', 'directory.verified': '已认证陪玩', 'directory.sessions': '{count} 次同行', 'directory.save': '收藏 {name}', 'directory.unsave': '取消收藏 {name}', 'directory.empty': '没有找到匹配的陪玩', 'directory.emptyHint': '试试其他名称、游戏或陪伴风格。', 'directory.loading': '正在加载陪玩…', 'directory.loadingHint': '正在点亮今夜的星群。', 'directory.loadError': '陪玩列表暂时无法加载', 'directory.retryHint': '请检查网络后重试，星群会再回来。', 'directory.retry': '重新加载', 'directory.available': '当前可点单', 'directory.noTagline': '进入名片了解更多', 'directory.viewCard': '查看名片', 'directory.pagination': '陪玩列表分页', 'directory.previous': '上一页', 'directory.next': '下一页', 'directory.page': '第 {page} / {pages} 页',
