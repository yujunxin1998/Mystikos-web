...
const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.home': 'Home', 'nav.shop': 'Shop', 'nav.membership': 'Membership', 'nav.language': '中文',
    'nav.theme': 'Colour theme', 'nav.menu': 'Open navigation', 'nav.close': 'Close navigation',
    ...
    'hero.primary': 'Find companions', 'hero.secondary': 'Browse the shop', 'hero.cardTitle': 'Tonight’s constellation',
    ...
    'companions.all': 'View all companions', 'companions.book': 'Order',
  ...
  zh: {
    ...
    'nav.home': '首页', 'nav.shop': '商城', 'nav.membership': '会员体系', 'nav.language': 'EN',
    'nav.theme': '色彩主题', 'nav.menu': '打开导航', 'nav.close': '关闭导航',
    'hero.eyebrow': '为值得铭记的游戏而设的公会', 'hero.title': '找到让每一次对局都更有意义的陪伴',
    'hero.body': 'Mystikos 汇聚专业陪玩、温柔仪式感，以及值得珍藏的品牌小物。',
    'hero.primary': '去找陪玩', 'hero.secondary': '逛奇物商城', 'hero.cardTitle': '今夜星群',
    ...
    'companions.all': '查看全部陪玩', 'companions.book': '点单',
...
Object.assign(copy.en, {
  ...
  'membership.perk1': 'Priority sessions', 'membership.perk2': 'Birthday keepsake', 'membership.perk3': 'Guild invitations',
  'profile.tabProfile': 'Profile', 'profile.tabSecurity': 'Security', 'profile.tabOrders': 'Orders', 'profile.tabWallet': 'Wallet',
  'profile.demoBadge': 'Sample', 'profile.demoNote': 'Coming soon — these figures are illustrative until the API ships.',
  'profile.accountSecurity': 'Account security', 'profile.accountSecurityHint': 'Password and login protections',
  'directory.eyebrow': 'COMPANION DIRECTORY · PUBLIC CARDS', 'directory.title': 'Who will you queue with tonight?', 'directory.open': 'Open to every Mystikos member', 'directory.intro': 'Explore games, play styles and availability. Choose a card to open the full public profile.', 'directory.heroHint': 'Certified companions · respond when available', 'directory.search': 'Search name, game or play style', 'directory.filterLabel': 'Companion filters', 'directory.all': 'All', 'directory.spotlight': 'Tonight’s picks', 'directory.heading': 'All companions', 'directory.count': '{count} companions', 'directory.verified': 'Verified companion', 'directory.sessions': '{count} sessions', 'directory.save': 'Save {name}', 'directory.unsave': 'Remove {name} from saved', 'directory.empty': 'No matching companions', 'directory.emptyHint': 'Try another name, game, or play style.', 'directory.loading': 'Loading companions…', 'directory.loadingHint': 'Gathering tonight’s constellation.', 'directory.loadError': 'Could not load companions', 'directory.retryHint': 'Check your connection, then try again.', 'directory.retry': 'Reload', 'directory.available': 'Available', 'directory.noTagline': 'Open the card to learn more', 'directory.viewCard': 'View card', 'directory.orderNow': 'Order', 'directory.pagination': 'Companion pages', 'directory.previous': 'Previous', 'directory.next': 'Next', 'directory.page': 'Page {page} of {pages}',
  'public.back': 'Back to companions', 'public.verified': 'Verified companion', 'public.rating': 'Member rating', 'public.sessions': 'Sessions together', 'public.response': 'Response rate', 'public.invite': 'Invite this companion', 'public.invited': 'Invitation sent · awaiting response', 'public.about': 'About', 'public.bookTitle': 'Book this companion', 'public.bookHint': 'Choose a date, start time and session length. Availability is confirmed when the order is created.', 'public.bookStart': 'Start time', 'public.bookChooseDate': 'Choose a date', 'public.bookChooseTime': 'Choose a start time', 'public.bookToday': 'Today', 'public.bookTomorrow': 'Tomorrow', 'public.bookDayAfter': 'Day after', 'public.bookCustomDate': 'Another date', 'public.bookCustomTime': 'Custom time', 'public.bookNoQuickTimes': 'No quick times remain today. Choose another date.', 'public.bookDuration': 'Session length', 'public.bookHours': '{hours} hr', 'public.bookEndsAt': 'Ends {time}', 'public.bookNextDay': 'Next day', 'public.bookSummary': 'Your selection', 'public.bookSummaryEmpty': 'Choose a valid date and time', 'public.bookPolicy': 'The server confirms final availability. You can review and pay after the order is created.', 'public.bookMissing': 'Choose a date and start time.', 'public.bookInvalid': 'Enter a valid date and start time.', 'public.bookTooSoon': 'Start time must be at least 15 minutes from now.', 'public.bookCta': 'Order now', 'public.bookWorking': 'Creating…', 'public.bookCart': 'Add to booking cart', 'public.bookCartWorking': 'Adding…', 'public.bookAdded': 'Added to your booking cart.', 'public.bookLegacy': 'This legacy demo card cannot place live orders.', 'public.voiceEmpty': 'No voice clips yet.', 'public.reviewsSoon': 'Reviews coming soon', 'public.reviewsSoonBody': 'Member reviews will show here after the ratings API ships.', 'public.highlights': 'HIGHLIGHTS', 'public.highlightsTitle': 'See how we play together.', 'public.highlight': 'Highlight', 'public.defaultHighlight': 'A calm comeback in the final round', 'public.voice': 'Voice note', 'public.voiceTitle': 'Hear my voice', 'public.playVoice': 'Play {name}', 'public.pauseVoice': 'Pause {name}', 'public.cancelVoice': 'Cancel loading {name}', 'public.retryVoice': 'Retry {name}', 'public.voicePlaybackFailed': 'Could not play · try again', 'public.seekVoice': 'Seek {name}', 'public.previousPhoto': 'Previous photo', 'public.nextPhoto': 'Next photo', 'public.viewPhoto': 'View photo {count}', 'public.photoAlt': '{name} photo {count}'
})
Object.assign(copy.zh, {
  ...
  'membership.perk1': '优先点单', 'membership.perk2': '生日纪念物', 'membership.perk3': '公会邀请',
  'profile.tabProfile': '资料', 'profile.tabSecurity': '安全', 'profile.tabOrders': '订单', 'profile.tabWallet': '钱包',
  'profile.demoBadge': '示例', 'profile.demoNote': '即将上线 — 当前为展示数据，不代表真实余额或订单。',
  'profile.accountSecurity': '账号安全', 'profile.accountSecurityHint': '密码与登录保护',
  'directory.eyebrow': '陪玩清单 · 认证陪玩', 'directory.title': '今晚，想和谁并肩？', 'directory.open': '向所有 Mystikos 会员开放', 'directory.intro': '查看陪玩的擅长游戏、陪伴风格与当前状态。选择一张名片，进入完整公开主页。', 'directory.heroHint': '有空即可响应', 'directory.search': '搜索名称、游戏或陪伴风格', 'directory.filterLabel': '陪玩筛选', 'directory.all': '全部', 'directory.spotlight': '今晚推荐', 'directory.heading': '全部陪玩', 'directory.count': '共 {count} 位陪玩', 'directory.verified': '已认证陪玩', 'directory.sessions': '{count} 次同行', 'directory.save': '收藏 {name}', 'directory.unsave': '取消收藏 {name}', 'directory.empty': '没有找到匹配的陪玩', 'directory.emptyHint': '试试其他名称、游戏或陪伴风格。', 'directory.loading': '正在加载陪玩…', 'directory.loadingHint': '正在点亮今夜的星群。', 'directory.loadError': '陪玩列表暂时无法加载', 'directory.retryHint': '请检查网络后重试，星群会再回来。', 'directory.retry': '重新加载', 'directory.available': '当前可点单', 'directory.noTagline': '进入名片了解更多', 'directory.viewCard': '查看名片', 'directory.orderNow': '立即点单', 'directory.pagination': '陪玩列表分页', 'directory.previous': '上一页', 'directory.next': '下一页', 'directory.page': '第 {page} / {pages} 页',
  'public.back': '返回陪玩清单', 'public.verified': '已认证陪玩', 'public.rating': '会员评分', 'public.sessions': '共同对局', 'public.response': '回应率', 'public.invite': '向这位陪玩发起邀请', 'public.invited': '邀请已发送 · 等待回应', 'public.about': '陪玩介绍', 'public.bookTitle': '预约这位陪玩', 'public.bookHint': '选择日期、开始时间与服务时长，创建点单时确认最终档期。', 'public.bookStart': '开始时间', 'public.bookChooseDate': '选择日期', 'public.bookChooseTime': '选择开始时间', 'public.bookToday': '今天', 'public.bookTomorrow': '明天', 'public.bookDayAfter': '后天', 'public.bookCustomDate': '其他日期', 'public.bookCustomTime': '自定义时间', 'public.bookNoQuickTimes': '今天已没有合适的快捷时段，请选择其他日期。', 'public.bookDuration': '服务时长', 'public.bookHours': '{hours} 小时', 'public.bookEndsAt': '预计 {time} 结束', 'public.bookNextDay': '次日', 'public.bookSummary': '本次点单', 'public.bookSummaryEmpty': '请选择有效的日期和时间', 'public.bookPolicy': '实际档期以后端确认为准；创建点单后可在订单页核对并支付。', 'public.bookMissing': '请选择日期和开始时间。', 'public.bookInvalid': '请输入有效的日期和开始时间。', 'public.bookTooSoon': '开始时间至少需要提前 15 分钟。', 'public.bookCta': '立即点单', 'public.bookWorking': '正在创建…', 'public.bookCart': '加入点单车', 'public.bookCartWorking': '正在加入…', 'public.bookAdded': '已加入点单车。', 'public.bookLegacy': '该演示名片暂不支持真实下单。', 'public.voiceEmpty': '暂未上传语音片段。', 'public.reviewsSoon': '评价即将上线', 'public.reviewsSoonBody': '会员评价将在评价接口上线后展示于此。', 'public.highlights': '精彩操作', 'public.highlightsTitle': '先看看我们的默契。', 'public.highlight': '精彩操作', 'public.defaultHighlight': '残局中的冷静反攻', 'public.voice': '语音片段', 'public.voiceTitle': '听听我的声音', 'public.playVoice': '播放 {name}', 'public.pauseVoice': '暂停 {name}', 'public.cancelVoice': '取消加载 {name}', 'public.retryVoice': '重试 {name}', 'public.voicePlaybackFailed': '播放失败 · 点击重试', 'public.seekVoice': '调整 {name} 的播放进度', 'public.previousPhoto': '上一张', 'public.nextPhoto': '下一张', 'public.viewPhoto': '查看第 {count} 张照片', 'public.photoAlt': '{name} 的照片 {count}'
})
