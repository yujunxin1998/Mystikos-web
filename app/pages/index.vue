...
<template>
  <section class="hero section-wrap">
    <div class="hero-copy">
      ...
      <div class="hero-actions"><a href="#companions" class="button button-primary">{{ t('hero.primary') }} <span>↓</span></a><NuxtLink to="/shop" class="button button-ghost">{{ t('hero.secondary') }} <span>↗</span></NuxtLink></div>
  ...
  <section id="ranking" class="ranking-section"><div class="section-wrap ranking-layout">
    <div class="ranking-copy"><p class="eyebrow"><span />{{ t('ranking.eyebrow') }}</p><h2>{{ t('ranking.title') }}</h2><div class="ranking-privacy"><span>◌</span><div><strong>{{ t('ranking.private') }}</strong><p>{{ t('ranking.privateText') }}</p></div></div></div>
  ...
  <section id="membership" class="section-wrap membership-section"><div class="membership-copy"><p class="eyebrow"><span />{{ t('membership.eyebrow') }}</p><h2>{{ t('membership.title') }}</h2><p>{{ t('membership.body') }}</p></div><div class="membership-card"><div class="member-card-top"><span>{{ t('membership.current') }}</span><strong>LV. 03</strong></div><h3>Devoted friend</h3><div class="member-line"><span>¥5,000</span><i><b /></i><span>¥20,000</span></div><p><strong>68%</strong> {{ t('membership.progress') }}</p><div class="membership-perks"><span>Priority sessions</span><span>Birthday keepsake</span><span>Guild invitations</span></div></div></section>
