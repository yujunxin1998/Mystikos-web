...
const baseCompanions: Omit<PublicCompanion, 'gameKeys' | 'gamesEn' | 'taglineEn' | 'bioEn' | 'statusEn'>[] = [
  { slug: 'ari-vale', name: 'Ari Vale', initial: 'A', games: ['Valorant', 'Apex 英雄'], tagline: '战术指挥 · 温柔沟通 · 不压力队友', bio: '擅长高压对局中的节奏判断，也享受轻松闲聊的深夜局。无论你想上分、复盘，还是只想找一个靠谱队友，我都会认真陪你打好这一场。', rating: '4.9', sessions: 68, responseRate: '98%', status: '今晚可点单', accent: '#bcaeff' },
  ...
  { slug: 'noah-lin', name: 'Noah Lin', initial: 'N', games: ['Apex 英雄', '永劫无间'], tagline: '快速支援 · 氛围轻松 · 决策果断', bio: '喜欢快速而清楚的团队决策，也擅长在紧张残局中稳定气氛。想练配合或快乐上分都可以。', rating: '4.8', sessions: 91, responseRate: '96%', status: '今晚可点单', accent: '#9bbcec' },
  { slug: 'lumi', name: 'Lumi', initial: 'L', games: ['英雄联盟', '永劫无间'], tagline: '耐心教学 · 新手友好 · 沟通细致', bio: '对新手足够耐心，会把复杂机制拆成容易执行的小步骤。输赢之外，更在意你是否真正玩得舒服。', rating: '4.9', sessions: 74, responseRate: '98%', status: '明晚可点单', accent: '#d6a9cf' },
  ...
  { slug: 'yue-mori', name: 'Yue Mori', initial: 'Y', games: ['Apex 英雄', '英雄联盟'], tagline: '轻松闲聊 · 情绪稳定 · 团队优先', bio: '不急不躁的团队型玩家，擅长照顾队伍节奏，也愿意陪你聊聊游戏之外的日常。', rating: '4.9', sessions: 103, responseRate: '99%', status: '今晚可点单', accent: '#e0b57a' },
  { slug: 'caro', name: 'Caro', initial: 'C', games: ['Valorant', '英雄联盟'], tagline: '战术复盘 · 英雄池指导 · 不傲慢', bio: '用直接但友好的方式给出建议，适合需要系统复盘或扩展英雄池的玩家。', rating: '4.8', sessions: 62, responseRate: '97%', status: '明晚可点单', accent: '#a9a0df' },
...
export const publicCompanions: PublicCompanion[] = baseCompanions.map((person, index) => ({
  ...
  statusEn: person.status === '在线' ? 'Online' : person.status === '明晚可点单' ? 'Available tomorrow' : 'Available tonight'
}))
